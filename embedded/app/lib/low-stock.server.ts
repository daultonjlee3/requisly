/**
 * Shared low-stock detection — used by notification evaluate and AI Procurement.
 *
 * Threshold precedence (per variant):
 * 1. Min positive supplier_products.low_stock_threshold among linked catalog rows
 * 2. Else workspace inventory_low notification_rules.threshold_value
 * 3. Else DEFAULT_LOW_STOCK_THRESHOLD
 *
 * On-hand aggregation matches draft-PO suggestion: lowest on-hand across locations.
 */
import type { SupabaseClient } from "@supabase/supabase-js";

/** Default when no product or rule threshold is set. */
